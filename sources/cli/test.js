describe('cli', function() {
    var bash = function(s, a, c) { return 'node '+__dirname+'/index.js -s '+s+' -a \''+a+'\' -c \''+c+'\''; };
    
    it('mixin', function(done) {
        this.timeout(5000);
        require('child_process').exec(bash(__dirname+'/mixin.js', '[2]', '{"b": 3}'), function(error, stdout, stderr) {
